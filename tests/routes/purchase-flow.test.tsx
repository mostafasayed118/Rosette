...
describe('local purchase flow', () => {
  it('moves from a catalog product to a confirmed demo order', async () => {
    ...
    const cart: Cart = addLine({ version: 2, lines: [], recipients: [] }, { id: 'rose-hour-classic', productSlug: product.slug, productName: product.name, tone: product.tone, unitPrice: product.price, quantity: 1, variantName: 'Classic', addOns: [], message: 'A bright day for you', deliveryDate: '2026-08-20' });
