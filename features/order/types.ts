...
import type { Cart, CartLine, CartRecipient, OrderTotals } from '@/features/cart/types';
...
export type CreatePendingOrderInput = { cart: Cart; destination: Destination; checkout: CheckoutInput; locale: 'en' | 'ar' | 'fr'; customerId?: string | null; recipients?: CartRecipient[] };
