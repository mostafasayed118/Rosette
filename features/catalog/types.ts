...
export type ProductVariant = { id: string; name: string; priceDelta: number };
export type AddOn = { id: string; name: string; price: number };
export type Product = { slug: string; name: string; nameAr?: string; description: string; descriptionAr?: string; category: string; occasions: string[]; price: number; tone: string; inventory: number; delivery: string; createdAt: string; variants: ProductVariant[]; addOns: AddOn[] };
