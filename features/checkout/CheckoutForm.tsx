...
const initialInput: CheckoutInput = { recipientName: '', recipientPhone: '', address: '', senderName: '', senderEmail: '', deliveryDate: defaultDeliveryDate(new Date()), deliveryWindow: '12-3', paymentMethod: 'paymob' };
