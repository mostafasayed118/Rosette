...
export type CheckoutInput = { recipientName: string; recipientPhone: string; address: string; senderName: string; senderEmail: string; deliveryDate: string; deliveryWindow: string; paymentMethod: PaymentMethod; promoCode?: string; giftCardCode?: string };
