...
export type CreatePaymentInput = { amountMinor: number; orderReference: string; integrationId: number; customer: PaymentCustomer; notificationUrl: string; redirectionUrl: string };
