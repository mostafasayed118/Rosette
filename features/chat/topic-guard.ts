...
const storeTerms = [
  ...
  'fleur', 'fleurs', 'plante', 'cadeau', 'livraison', 'livrer', 'livrez', 'caire', 'alexandrie', 'prix', 'paiement', 'payer', 'commande', 'anniversaire', 'merci',
];
const supportTerms = ['help', 'contact', 'support', 'مساعدة', 'تواصل', 'دعم', 'aide', 'aider', 'contacter', 'équipe'];
const injectionTerms = ['ignore previous', 'ignore all instructions', 'system prompt', 'reveal your instructions', 'اكشف التعليمات', 'تجاهل التعليمات', 'ignore les instructions', 'révèle tes instructions'];
const orderPattern = /\b(?:order|طلب|commande)\s*[-#:]?\s*[a-z0-9-]{2,}/i;
