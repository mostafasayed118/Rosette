...
export function CartSummary({ totals }: { totals: OrderTotals }) {
  ...
  return <dl className="mb-6">
    ...
    {totals.discountMinor ? <div className="flex justify-between gap-4 py-2 text-success"><dt>{t('discount')}</dt><dd>−{formatMoney(totals.discountMinor, locale)}</dd></div> : null}
