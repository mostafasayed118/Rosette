...
function CartProgress() {
  return (
    <div className="mb-10 flex items-center justify-center gap-4 md:gap-8 max-w-2xl mx-auto">
      ...
      <div className="flex flex-col items-center">
        <div className="w-8 h-8 rounded-full border border-primary text-primary grid place-items-center font-mono text-[13px] tracking-[0.05em]">2</div>
        <span className="mt-2 text-sm text-on-surface">Delivery</span>
      </div>
      <div className="h-px w-12 md:w-24 bg-outline-variant/50 self-start mt-4 shrink-0" aria-hidden />
